...
#SBATCH --output=slurm/slurm_output/april14/baseline/%x_%j.out
#SBATCH --error=slurm/slurm_output/april14//baseline/%x_%j.err
...
python baseline_offline.py --config configs/config_1.yaml
